...
% global variables
global gamma_1 lambda_1 delta z1Star1 z1Star2 z1Star3 z1Star4 eta etaPrime etaBar distance
%%%%%%%%%%%%%%%%%%%%%%%
% setting the globals %
%%%%%%%%%%%%%%%%%%%%%%%

lambda_1 = 130; % Gravity. 
...
gamma_1 = 3/4; % Viscous friction to mass ratio.
